      ...
      {[
        {
          ...
          label: "between AI and Machine Learning?",
          action: "Explain the difference between AI and Machine Learning?",
        },
        {
    title: "Translate the sentence",
    label: "into Kannada",
    action: "Translate 'How are you today?' into Kannada",
  },
        {
        ...
        },
        {
          ...
          label: "in Bijapur?",
          action: "What is the weather in Bijapur?",
        },
